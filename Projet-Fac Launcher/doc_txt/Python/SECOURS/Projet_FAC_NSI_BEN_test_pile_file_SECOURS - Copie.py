...
def menu():
    ...
    liste_button.empiler(Bouton1)
    liste_button.empiler(Bouton2)
    liste_button.empiler(Bouton3)
    liste_button.empiler(Bouton4)
    liste_button.empiler(Bouton5)
    liste_button.empiler(Bouton6)
    liste_button.empiler(Bouton7)
    liste_button.empiler(Bouton8)
    liste_button.empiler(Bouton9)
    liste_button.empiler(Bouton10)
    liste_button.empiler(Bouton45)
...
def jeux_1_lettre_2():                  
    ...
    global dico_ltr_img, dico_ltr_img_coord, compteur, cand_rep,liste_button, dico_ltr_to_modify_image
    ...
    liste_button.empiler(Bouton14)
    liste_button.empiler(Bouton15)
    liste_button.empiler(Bouton16)
    liste_button.empiler(Bouton17)
    liste_button.empiler(Bouton18)
    liste_button.empiler(Bouton19)
    liste_button.empiler(Bouton20)
    liste_button.empiler(Bouton21)
    liste_button.empiler(Bouton22)
    liste_button.empiler(Bouton23)
    ...
    liste_button.empiler(Bouton25)

def Make_Rep(t_lettre:str, bouton_mk:str):
    global cand_rep, cand_rep_str,liste_button, tempo, pile_supp
...
def retire_elt_rep():
    ...
    liste_button.empiler(dico_ltr_bouton[tempo])
...
def operation():
    ...
    liste_button.empiler(Bouton_rep)
...
def fin_du_jeu():
    ...
    liste_button.empiler(Bouton_menu)
    score1 = StringVar()
    Labelscore = Label(MaFenetre, textvariable = score1 , bg ="white",font=("Courier",60),width=13,height=2)
    score1.set(Score.get_score())
