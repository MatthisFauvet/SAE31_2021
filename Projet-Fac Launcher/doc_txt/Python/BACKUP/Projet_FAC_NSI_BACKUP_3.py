...
Menu_tele_score=PhotoImage(file="images/images_menu/Menu_tele_score.png")
fond_jeux_inexistant_10=PhotoImage(file="images/images_menu/RickAstley.png")
...
def jeux_1_regles():
    ...
    Bouton_arret = bouton([21, 913],[374, 1025],"Arreter",None,"fin_du_jeu()",None)
    liste_button.append(Bouton_arret)
...
def jeux_1_lettres():
    ...
    global liste_button, l_mot_trouver #, lettre0, lettre1, lettre2, lettre3, lettre4, lettre5, lettre6, lettre7, lettre8, lettre9
    ...
    can1.after(1000,affiche_image(epreuve_lettre))
    can1.update()
...
def jeux_1_lettre_2():                  
    ...
    global dico_ltr_img, dico_ltr_img_coord, compteur, cand_rep
    ...
    Bouton24 = bouton([1446, 839], [1809, 956], " VALIDER ", None, 'est_mot()', None)
...
def est_mot():
    ...
    for elt in lst_fr:
        if elt == cand_rep_str:
            ...
            score_chiffre()
            return(True)
    print("""dsl vous le mot n'existe pas. n'hésitez pas a nous envoyer un mail pour que le mot soit potentielement ajouter""")
