...
def menu():
    global can1, Bouton1, Bouton2, Bouton3, Bouton4, Bouton5, Bouton6, Bouton7,Bouton8, liste_button, bou1, cand_rep, compteur
    ...
    Bouton10 = bouton([1169, 544], [1202, 561],"Bouton10", None, "test()", None)
    
    liste_button=[Bouton1, Bouton2, Bouton3, Bouton4, Bouton5, Bouton6, Bouton7, Bouton8, Bouton9, Bouton10]
    
    # ===================== INITIALISATION DES BOUTONS ========================
    
    bou1=Button(MaFenetre,text="Niveaux",command=test)
...
def jeux_1_init():
    ...
    can1.update()
    score1 = StringVar()
    Labelscore = Label(MaFenetre, textvariable = score1 , bg ="white",font=("Courier",60),width=3,height=1)
...
def jeux_1():
    ...
    a=randint(0,0) # Création d'une variable avec un chiffre aléatoire
...
def jeux_1_lettres():
    ...
    can1.update()
    can1.after(1000,affiche_image(plato_lettre))
    can1.update()
    ...
    lettre0=l_mot_trouver[0][0]
    lettre1=l_mot_trouver[1][0]
    lettre2=l_mot_trouver[2][0]
    lettre3=l_mot_trouver[3][0]
    lettre4=l_mot_trouver[4][0]
    lettre5=l_mot_trouver[5][0]
    lettre6=l_mot_trouver[6][0]
    lettre7=l_mot_trouver[7][0]
    lettre8=l_mot_trouver[8][0]
    lettre9=l_mot_trouver[9][0]
    ...
    global dico_ltr_img, dico_ltr_img_coord
...
def score_chiffre():
    ...
    if len(cand_rep_str)-1==10:
        ...
        # can1.after(2000,Labelscore.destroy())
        # btn2 =Button(MaFenetre, text='Masquer', command=lambda: Labelscore.pack_forget())
        # btn2.pack()
        # btn3 =Button(MaFenetre, text='Afficher le score', command=lambda: Labelscore.pack())
        # btn3.pack(pady=20)
        # can1.after(2000000000,jeux_1_operations())
        # can1.update()
...
def rep():
    global Champ1,LabelResultat,LabelResultat2,LabelResultat3,LabelResultat4
    Res=int(Champ1.get())
    print(Res)
    print("oui")
...
# def reponse(operation):
#     global liste_button,Champ1
    

def resultat(reponse):
    global operation1,Champ1
    print("bonjour")
    Champ1.destroy()
...
def test():
    playsound("operations_manuscrites.wav", block=False)
